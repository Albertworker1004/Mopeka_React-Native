var lang_data = {
  ...
  signal: 'Signal',
  quality: 'Quality',
  title: 'BMPRO SmartSense',
  name: 'name',
  level: 'level',
  scanning: 'Scanning',
  start_scan: 'Start Scan',
  tank_check_devices: 'SmartSense Devices',
  ...
  no_devices_message: 'No SmartSense devices have been added.',
  first_time_message1:
    'You can purchase new SmartSense sensors and accessories from our <a href="#" onclick="window.open(\'' +
    getShopLink() +
    "', '_blank', 'location=yes')\"><b>Online Store</b></a>.",
  first_time_message2:
    "For help syncing your sensor, please visit our <a href=\"#\" onclick=\"window.open('https://teambmpro.com/products/lpg-gas-level-monitor-smartsense', '_blank', 'location=yes')\"><b>Instructions Page</b></a>.",
  menu: 'Menu',
  delete: 'Delete',
