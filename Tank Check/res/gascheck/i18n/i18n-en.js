var lang_data = {
  ...
  tank_check_devices: 'Gasnow Devices',
  ...
  no_devices_message: 'No Gasnow devices have been added.',
  first_time_message1:
    'You can purchase new Gasnow sensors and accessories from our <a href="#" onclick="window.open(\'' +
    getShopLink() +
    "', '_blank', 'location=yes')\"><b>Online Store</b></a>.",
  first_time_message2:
    "For help syncing your sensor, please visit our <a href=\"#\" onclick=\"window.open('http://gasnow.cl/', '_blank', 'location=yes')\"><b>Instructions Page</b></a>.",
  menu: 'Menu',
  delete: 'Delete',
  ...
  accStep1: 'Step 1. Prior to installing on tank, press the “Sync” button on the sensor to enable hyper update mode.',
  accStep2:
    'Step 2. It is good practice to first zero calibrate the leveling tool. Place your sensor on a known flat surface and then press:',
  accZeroSensor: 'Zero Sensor',
  accStep3:
    'Step 3. Now install the sensor on the tank and use the leveling tool below to adjust the sensor position until it is level.',
  accConfirmMsg:
