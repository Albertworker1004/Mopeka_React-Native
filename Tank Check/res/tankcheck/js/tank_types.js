...
var tank_types = {
  ...
  il: [
    ...
    { type: '5kg', label: '4.5-5kg', vertical: true, height: 0.28 * 0.8 }, //0.300
    { type: '12kg', label: '12kg', vertical: true, height: 0.4 * 0.8 }, //0.390
    { type: '48kg', label: '48kg', vertical: true, height: 1.04 * 0.8 }, //1.025
  ],
