var lang_data = {
  ...
  tank_check_devices: 'Vertrax ✓ Devices',
  ...
  no_devices_message: 'No Vertrax ✓ devices have been added.',
  first_time_message1:
    'You can purchase new Vertrax ✓ sensors and accessories from our <a href="#" onclick="window.open(\'' +
    getShopLink() +
