...
var tank_types = {
  ...
  es: [
    ...
    { type: '45kg', label: '45kg, Vertical', vertical: true, height: 1.0 },
    { type: '470L', label: '470L, Vertical', vertical: true, height: 0.94 },

    // for horizontal tanks, 'height' = diameter - see here https://www.lykinsenergy.com/Uploads/files/Tank_Specifications.png
    // From Manuel/Reese email: Jan 21, 2019, 3:21 PM
    { type: '1000L', label: '1000L, Horizontal', vertical: false, height: 0.86 },
    { type: '2000L', label: '2000L, Horizontal', vertical: false, height: 1.05 },
    { type: '4000L', label: '4000L, Horizontal', vertical: false, height: 1.05 },
  ],
