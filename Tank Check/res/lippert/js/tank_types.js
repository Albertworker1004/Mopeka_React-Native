...
var tank_types = {
  ...
  // tank labels changed back to old sizes, but keep the BMPro heights. Leaving type as old type so existing users won't have their tanktype changed/reset
  au: [
    { type: '8.5kg', label: '9kg', vertical: true, height: 0.342 * 0.78 },
    { type: '3.7kg', label: '4.5kg', vertical: true, height: 0.235 * 0.78 },
  ],
}
