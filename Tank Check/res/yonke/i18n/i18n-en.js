var lang_data = {
  ...
  tank_info: 'Cylinder Info',
  tank_level: 'Cylinder Level',
  ...
  tank_check_devices: 'Yonke ✓ Devices',
  device_name: 'Device Name',
  tank_type: 'Cylinder Size',
  arbitrary: 'Arbitrary',
  tank_level_units: 'Cylinder Level Units',
  percent: 'Percent',
  inches: 'Inches',
  centimeters: 'Centimeters',
  voltage: 'Voltage',
  set_tank_height: 'Set Cylinder Height',
  set_tank_height2: 'Cylinder Height in',
  signal_strength: 'Signal Strength',
  no_devices_message: 'No Yonke ✓ devices have been added.',
  first_time_message1:
    'You can purchase new Yonke ✓ sensors and accessories from our <a href="#" onclick="window.open(\'' +
    getShopLink() +
    "', '_blank', 'location=yes')\"><b>Online Store</b></a>.",
  first_time_message2:
    "For help syncing your sensor, please visit our <a href=\"#\" onclick=\"window.open('http://www.yonkegas.com/index.php/help', '_blank', 'location=yes')\"><b>Instructions Page</b></a>.",
  menu: 'Menu',
  delete: 'Delete',
  ...
  enable_filter_help:
    'This will enable a search/filter box above your sensor list.  Only sensors that match the text you type will be visible.  If you have a lot of sensors and cylinder, this can help you manage and find them in the list better.',
  alarm_thresh: 'Alarm Threshold',
  alarm_thresh_help:
    'Set a low-level alarm threshold for your cylinder.  When the level crosses below this alarm you will be sent a notification on your phone (if enabled in the main menu).  The app will also show you a warning icon and options to help you refill your cylinder.',
  ...
  tank_info_help:
    'This displays the height of LPG, or percentage fill level of your cylinder. If the readings seem incorrect or are bouncing, follow these tips to increase the quality. These steps are listed in the order of importance, so step through each until your readings return to normal.\n\n1. Make sure cylinder is on a very level surface.\n\n2. Firmly place sensor directly in the center bottom of the cylinder. There should be a small flat spot on the center of most cylinder.\n\n3. Make sure your tank is not resting on the sensor and that the tank has not damaged it.  Use the provided spacers or other means to provide clearance for the sensor if your tank requires it.\n\n4. Wipe any possible sand or dirt off the bottom of the tank where the sensor and the tank make contact. Ensure the bottom of your cylinder is dry and free of moisture.\n\n5. Make sure the small rubber ring on your sensor is cleaned and intact and that the magnets are firmly seated and not loose.\n\n6. Certain tanks may be more difficult to read and might have more debris inside along with layers of paint and rust added over the years. Try the sensor on a newer tank or different brand of tank if possible.',
  device_name_help:
    'Set a friendly name for this sensor and cylinder so that you can easily identify it.  This name is only saved on your phone, so if you use multiple phones you will need to assign the name on each.',
  tank_type_help:
    'Set the size of your cylinder so that the app can display a percentage read-out. For unlisted sizes or horizontal cylinder, you should measure the cylinder\'s height and enter it into the "Arbitrary" field.  For horizontal cylinder the percentage displayed will be the measured fluid height relative to the height you enter in the "Arbitrary" field.',
  tank_level_units_help:
    'Change the units that are displayed on the main and detailed cylinder information pages for your cylinder level.',
  firmware_prefix: 'Yonke ✓',
  ...
  notify_title: 'LPG cylinder level is low!',
  ...
  // Bridge (Gateway)
  login_page_msg:
    "Create an account to manage your sensors across different phones and tablets. <br /><br />If you purchase a Yonke Bridge from our <a href=\"#\" onclick=\"window.open('http://www.yonkegas.com/index.php/order-online', '_blank', 'location=yes');\">online store</a>, it will update sensor data to the cloud so you can read your sensors from anywhere.",
