var lang_data = {
  ...
  signal: 'Signal',
  quality: 'Quality',
  title: 'MT Tracker BBQ',
  name: 'name',
  level: 'level',
  scanning: 'Scanning',
  start_scan: 'Start Scan',
  tank_check_devices: 'MT Tracker BBQ™ Devices',
  ...
  no_devices_message: 'No MT Tracker BBQ™ devices have been added.',
  first_time_message1:
    'The first time you use your MT Tracker BBQ™ sensor, press the "Sync" button 5 times in a row to initialize it.  To add new sensors, make sure the scanning icon is spinning and then hold down the sync button on your sensor until it is found',
  first_time_message2: '',
  menu: 'Menu',
  delete: 'Delete',
  ...
  enable_filter_help:
    'This will enable a search/filter box above your sensor list.  Only sensors that match the text you type will be visible.  If you have a lot of sensors and cylinders, this can help you manage and find them in the list better.',
  ...
  tank_info_help:
    'This displays the height of LPG, or percentage fill level of your cylinder. If the readings seem incorrect or are bouncing, follow these tips to increase the quality. These steps are listed in the order of importance, so step through each until your readings return to normal.\n\n1. Make sure your cylinder is on a very level surface.\n\n2. Firmly place sensor directly in the center bottom of the cylinder. There should be a small flat spot on the center of most cylinders.\n\n3. Make sure your cylinder is not resting on the sensor and that the cylinder has not damaged it.  Use spacers or other means to provide clearance for the sensor if your cylinder requires it.\n\n4. Wipe the bottom of the cylinder the sensor and the cylinder make contact. Ensure the bottom of your cylinder is dry and free of moisture.\n\n5. Make sure the small rubber ring on your sensor is cleaned and intact and that the magnets are firmly seated and not loose.\n\n6. Certain cylinders may be more difficult to read and might have more debris inside along with layers of paint and rust added over the years. Try the sensor on a newer cylinder or different brand of cylinder if possible.',
  device_name_help:
  ...
  tank_type_help:
    'Set the size of your cylinder so that the app can display a percentage read-out. For unlisted sizes or horizontal cylinders, you should measure the cylinder\'s height and enter it into the "Arbitrary" field.  For horizontal cylinders the percentage displayed will be the measured fluid height relative to the height you enter in the "Arbitrary" field.',
  ...
  firmware_prefix: 'MT Tracker BBQ',
