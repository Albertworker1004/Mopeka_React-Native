...
const Collapsible = ({ title, children, icon, iconEnabled, text, textEnabled }: CollapsibleProps) => {
  ...
  return (
    <div className="flex flex-col">
      <div
        ref={header}
        onClick={toggle}
        className={`flex px-8 py-6 border-b ${open ? 'collapsible-open-theme' : 'collapsible-close-theme'}`}>
        {iconEnabled && (
