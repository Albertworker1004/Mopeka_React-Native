var lang_data = {
  ...
  new_h20_device: 'New Tank Sensor',
  ...
  voltage: 'Voltage',
  set_tank_height: 'Tank Height',
  set_tank_height2: 'Tank Height in',
  signal_strength: 'Signal Strength',
  no_devices_message: 'No Mopeka ✓ devices have been added.',
  first_time_message1:
  ...
  first_time_message2:
    "For help syncing your sensor, please visit our <a href=\"#\" onclick=\"window.open('http://mopeka.com/homepage/instructions/', '_blank', 'location=yes')\"><b>Instructions Page</b></a>.",
  menu: 'Menu',
  delete: 'Delete',
  ...
  change_update_rate:
    'Hold the SYNC button for 5 seconds to toggle between update rates.\n\nCloud sync indicated sensor is out of range of the device, and receiving updates from the cloud.',
  ...
  // Bridge (Gateway)
  login_page_msg:
    'Create an account to manage your sensors across different phones and tablets. If you purchase a Mopeka Bridge from our online store, it will update sensor data to the cloud so you can read your sensors from anywhere. You can even use Alexa or Google Home to monitor them - e.g. "Alexa, how much propane is in my BBQ tank?".',
